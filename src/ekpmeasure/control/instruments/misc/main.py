...
def _get_number_and_suffix(string):
    ...
    """
    warnings.showwarning(
        "_get_number_and_suffix will be deprecated. Please use ekpmeasure.universal._get_number_and_suffix",
        DeprecationWarning,
        "",
        0,
    )
...
def scientific_notation(number):
    ...
    """
    warnings.showwarning(
        "scientific_notation will be deprecated. Please use ekpmeasure.universal.scientific_notation",
        DeprecationWarning,
        "",
        0,
    )
...
def _scientific_notation(number):
    warnings.showwarning(
        "_scientific_notation will be deprecated. Please use ekpmeasure.universal._scientific_notation",
        DeprecationWarning,
        "",
        0,
    )
